...
public class MemberController {
	...
	public String certificationEmail(MemberVO vo,String email,Model model) {
		try {
			...
			sendMailUtil.sendMail("[Funthing] ¿Œ¡ıƒ⁄µÂ ¿‘¥œ¥Ÿ.", "¿Œ¡ıƒ⁄µÂ : ["+certificationCode+"]", vo.getEmail());   
    ...
    public String updatePw(MemberVO vo,String email) {
    	...
    	try {
			...
			sendMailUtil.sendMail("[Funthing] ¿”¿«∑Œ ª˝º∫µ» ∫Òπ–π¯»£ ¿‘¥œ¥Ÿ.", "πﬂº€µ» ∫Òπ–π¯»£∑Œ ∑Œ±◊¿Œ¿ª «œΩ√∞Ì ≤¿ "
					+ "∏∂¿Ã∆‰¿Ã¡ˆ - »∏ø¯¡§∫∏ºˆ¡§ ø°º≠ ∫Òπ–π¯»£∏¶ ∫Ø∞Ê«œø© ¿ÃøÎø° ∫“∆Ì«‘¿Ã æ¯¿∏Ω√±Ê πŸ∂¯¥œ¥Ÿ. "
					+ "∫Òπ–π¯»£ : ["+password+"]", vo.getEmail());
