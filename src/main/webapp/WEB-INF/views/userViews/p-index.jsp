...
<body>
				...
				<div class="row">
					...
					<div class="col-xl-3 col-md-6 col-lg-3">
						<div class="footer_widget">
							...
							<a href="#" class="line-button">프로젝트 올리기</a>
						</div>
					</div>
					...
					<div class="col-xl-3 col-md-6 col-lg-4">
						<div class="footer_widget">
							<h3 class="footer_title">검색하기</h3>
							<form action="#" class="search_form">
								<input type="text" placeholder="">
								<button type="submit">검색</button>
							</form>
							<p class="search_text">원하시는 프로젝트를 입력해주세요.</p>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- 로그인 팝업페이지-->
	<form id="login-popup" class="white-popup-block mfp-hide" action="#"
		method="post">
		<div class="popup_box ">
			<div class="popup_inner">
				<h3>로그인</h3>
				<!-- 쿠키가 비어있찌 않을때 체크 속성주기 -->
				<c:if test="${not empty cookie.email}">
					<c:set value="checked" var="checked" />
				</c:if>
				<div class="mt-10">
					<input type="text" id="login-id" name="email" placeholder="이메일 아이디"
						onfocus="this.placeholder = ''"
						onblur="this.placeholder = '이메일 아이디'" required
						class="single-input" value="${cookie.email.value }">
				</div>
				<div class="mt-10">
						...
						<div class="col-5">
							<div class="switch-wrap d-flex justify-content-start ml-3">
								<div class="confirm-switch mr-1">
									<input type="checkbox" id="confirm-switch" name="confirm_email" ${checked} > <label
				...
				<div class="col-xl-12 mt-10">
					...
					<button class="boxed-btn3" onclick="loginMember.udo">
						로그인하기</button>
				...
				<div class="col-xl-12 mt-10 kakao_login_btn-wrapper">
					<a class="kakao_login_btn" href="#"> <img class="landscape"
						src="${pageContext.request.contextPath}/resources/user/img/apiBtn/naverLoginBtn/네이버 아이디로 로그인_완성형_White.PNG" />
					</a>
				</div>
	...
	<script
		src="${pageContext.request.contextPath}/resources/user/js/loginajax.js"></script>
