			...
			<div class="col-6">
				...
				<div class="col mt-5 ">
					...
					<div class="d-flex justify-content-start mt-5">
						<div class="col-3 mr-4">프로필 사진 (변경하시려면 사진을 눌러 변경할 사진을 선택해
							주세요)</div>
						<div class="col-10">
							<form id="imageupload" action="#" method="post"
									...
									<div class="col-5 align-self-center">
										<label for="image"> <input type="file" name="image"
											...
											<div id="detail-mypage-profile-img" class="">
												<img class="profile"
													src="${pageContext.request.contextPath}/resources/user/img/test/2.jpg">
											</div>
										</label>
									</div>
