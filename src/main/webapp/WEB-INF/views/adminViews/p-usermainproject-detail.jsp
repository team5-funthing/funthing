										...
										<!-- 중간 내용 들어가는 부분 -->
											...
											<section class="container">
												...
												<div class="w-100">
													<div>
														업체명
														<h2>${userMainProject.creator}</h2>
													</div>
													<article class="row d-flex justify-content-center">
														<aside id="project-main-img" class="col-7">
															<div>${userMainProject.projectIntroduceVideo}</div>
														</aside>
														<aside id="project-details-info" class="col-5 align-items-start d-flex flex-column bd-highlight">
 															<div class="p-2 bd-highlight">
																...
																<div class="h2" style="color: #000000">
																	${userMainProject.fundingMoney}원
																	<div class="h5" style="color: #000000">${(userMainProject.fundingMoney /userMainProject.goalMoney) * 100}%
																		[달성율]</div>
																</div>
															</div>
															...
															<fmt:formatDate var="endDate" value="${userMainProject.endDate}" pattern="yyyyMMdd" />
													...
													<div class="w-75">
														<article>
															<div class="row">
																<div class="col-lg-10 posts-list">
																	<div class="single-project-details">
																		...
																		<div class="blog_details">
																			<h3>${userMainProject.projectSubTitle }</h3>
																			<ul class="project-info-link mt-3 mb-4">
																				<li><i class="fa fa-user"></i>${userMainProject.category }</li>
																			</ul>
																			<div>${userMainProject.projectStory}</div>
																		</div>
																	</div>
																	<hr>
																	<form action="insertFocusProject.ado" method="POST">
																		<div align="center">
																			<input type="hidden" name="projectNo"
																				value="${userMainProject.projectNo}"> <input
																				type="submit" value="주목 프로젝트에 추가하기"> <a
																				href="getUserMainProjectList.ado"><input
																...
																<div class="col-2">
																	<!-- 리워드 품목 들어가기 -->
																	<c:forEach var="rewards" items="${userMainProject.reward}">
