            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">회원가입 약관 목록</h4>
                ...
                <div class="p-20">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title m-b-0">회원가입 약관 목록</h5>
                                <div class="table-responsive">                                 
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th style="width: 150px;" >회원가입 약관 번호</th>
                                                <th style="width: 200px;">회원가입 약관 제목</th>          
                                            </tr>
                                        </thead>
                                        <tbody>    
                                        	<c:forEach var="tosList" items="${RegisterTosList}">                    
	                                       		<tr>
	                                       			<td>${tosList.registerNo}</td>
	                                       			<td><a href="getRegisterTos.ado?registerNo=${tosList.registerNo}">${tosList.registerTosTitle}</a></td>
	                                       		</tr>
	                                       	</c:forEach>
                                        </tbody>
                                    </table>
                                ...
                                <div align="center" style="padding-right: 10%;">
                                    <a href="inputRegiTos.ado"><input type="button" value="약관 등록"></a>
                                </div>
