            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">공지사항 목록</h4>
                ...
                <div class="p-20">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title m-b-0">공지사항 목록</h5>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 200px;">등록자 아이디</th>
                                                <th>제목</th>
                                                <th style="width: 80px;">등록 날짜</th>
                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                        
                                        <c:forEach var="list" items="${entireBoardList}">
                                        <tr>
                                        	<td>${list.noticeNo}</td>
                                        	<td>${list.adminId}</td>
                                        	<td><a href="getAdminNoticeBoard.ado?no=${list.noticeNo}">${list.noticeTitle}</a></td>
                                ...
                                <div align="center" style="padding-right: 10%;">
                                    <a href="insertAdminBoard.ado"><input type="button" value="글 등록"></a>
                                </div>
