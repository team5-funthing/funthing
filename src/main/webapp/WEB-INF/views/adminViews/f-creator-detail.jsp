            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">creator_detail</h4>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body" align="center">
                                        <h5 class="card-title m-b-0" style="padding-bottom: 5%;">상세보기 창작자 심사 탭</h5>
                                        <table>
                                            <tr>
                                                <th style="padding: 2%;">업체명</th>
                                                <td><input type="text"></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <th style="padding: 2%;">창작자명</th>
                                                <td><input type="text"></td>
                                                <th style="padding-left: 2%;">창작자 이메일</th>
                                                <td><input type="text"></td>
                                            </tr>
                                            <tr>
                                                <th style="padding: 2%;">창작자 H·P</th>
                                                <td><input type="text"></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
