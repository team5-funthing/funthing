...
<body>
    ...
    <div id="main-wrapper">
		...
		<form action="deleteFocusProject.ado" method="POST">					
		<div align="center">
			<input type="hidden" name="projectNo"  value="${focusProject.projectNo}">			
			
			<input type="submit" value="주목 프로젝트 해제">
			<a href="http://localhost:8080/funthing/getFocusProjectList.ado"><input type="button" value="목록"></a>
