...
<ul class="nav nav-tabs" role="tablist">
    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">카테고리별 비율</span></a> </li>
    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#home2" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">카테고리별 성공비율</span></a> </li>  
</ul>
...
<div class="tab-content tabcontent-border">
    ...
    <div class="p-20">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title m-b-0">카테고리별 비율</h5>
    ...
    <div class="tab-pane  p-20" id="home2" role="tabpanel">
        ...
        <div class="p-20">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title m-b-0">카테고리별 성공비율</h5>
                            <form style="float: right;">
                                <select>
                                    <option value="">분류</option>
                                    <option value="">분류2</option>
        ...
        <!-- this page js -->
        <script src="${pageContext.request.contextPath }/resources/admin/assets/libs/chart/matrix.interface.js"></script>
        <script src="${pageContext.request.contextPath }/resources/admin/assets/libs/chart/excanvas.min.js"></script>
        ...
        <script src="${pageContext.request.contextPath }/resources/admin/assets/libs/chart/jquery.peity.min.js"></script>
        <script src="${pageContext.request.contextPath }/resources/admin/assets/libs/chart/matrix.charts.js"></script>
        <script src="${pageContext.request.contextPath }/resources/admin/assets/libs/chart/jquery.flot.pie.min.js"></script>
        <script src="${pageContext.request.contextPath }/resources/admin/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
        <script src="${pageContext.request.contextPath }/resources/admin/assets/libs/chart/turning-series.js"></script>
